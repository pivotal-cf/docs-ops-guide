...
The **Resource Config** page of Pivotal Elastic Runtime tile in the Pivotal Cloud Foundry&reg; (PCF) Ops Manager shows the 24 components that the Ops Manager Director installs.
